...
/*
export default class ViewDetails extends React.Component<any, any> {
    ...
    render() {
        ...
        this.posterData = this.props;

        if(this.posterData == undefined) {
            return (
                <SafeAreaView style={styles.loading_container}>
                    <View style={styles.inner_container}>
                        <View style={styles.text_arrange}>
                            <Text style={styles.text_inner}>Loading, please wait...</Text>
                        </View>
                    </View>
                </SafeAreaView>
            )
              ...
              <ScrollView style={styles.scrollView}>
                <View style={styles.inner_view}>
                    ...
                    <View style={styles.image_container}>
                        <Image
                          style={styles.stretch_new}
                          source={{uri: this.posterData.posterUrl}}
                        />
                    </View>
                    <View style={styles.text_container}>

                        <View style={styles.line_dashed}>
                            <Text style={styles.bold_title}>{this.posterData.title}</Text>
                        </View>
                        <View style={styles.line_dashed}>
                            <Text style={styles.description_title}>Genres:</Text>
                            <Text style={styles.normal_title}>{this.posterData.genres.join(', ')}</Text>
                        </View>
                        <View style={styles.line_dashed}>
                            <Text style={styles.description_title}>Director:</Text>
                            <Text style={styles.normal_title}>{this.posterData.director}</Text>
                        </View>
                        <View style={styles.line_dashed}>
                            <Text style={styles.description_title}>Actors:</Text>
                            <Text style={styles.normal_title}>{this.posterData.actors}</Text>
                        </View>
                        <View style={styles.plot}>
                            <Text style={styles.normal_title}>{this.posterData.plot}</Text>
                        </View>
